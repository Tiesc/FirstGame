System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  function _reportPossibleCrUseOfHex(extras) {
    _reporterNs.report("Hex", "./HexCell", _context.meta, extras);
  }

  function _reportPossibleCrUseOfLayout(extras) {
    _reporterNs.report("Layout", "./HexCell", _context.meta, extras);
  }

  function _reportPossibleCrUseOfOffsetCoord(extras) {
    _reporterNs.report("OffsetCoord", "./HexCell", _context.meta, extras);
  }
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "b90a1V5Ct9DCaYodLQA4M3b", "HexMap2D-001", undefined); // HexMap.ts
...
//# sourceMappingURL=4cea7355929913c80521fe11672f26da962f7eeb.js.map