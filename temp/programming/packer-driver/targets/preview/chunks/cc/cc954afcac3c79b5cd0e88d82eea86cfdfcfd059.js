  ...
  return {
    ...
    execute: function () {
      ...
      _export("PlayerController", PlayerController = (_dec = ccclass("PlayerController"), _dec2 = property(Animation), _dec3 = property(Node), _dec4 = property(Node), _dec(_class = (_class2 = class PlayerController extends Component {
        ...
        setupTouchAreas() {
          var screenSize = view.getVisibleSize(); // 获取屏幕尺寸

          var halfWidth = screenSize.width / 2; // 屏幕宽度的一半

          var height = screenSize.height; // 屏幕高度
          // 设置 leftTouch 的大小、锚点和位置

          var leftTransform = this.leftTouch.getComponent(UITransform);
          ...
          var rightTransform = this.rightTouch.getComponent(UITransform);
...
//# sourceMappingURL=cc954afcac3c79b5cd0e88d82eea86cfdfcfd059.js.map